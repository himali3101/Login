...
public class JwtUtil {
 // This is one of the biggest security issues that has even brought down big corporations
...
//	private String SECRET_KEY = "secret";
	...
	public String generateToken(String username, String role) {
		...
		return Jwts.builder()   // creates an empty jwt
				.claim("usr",username)   // adds key value pair to the json payload. This specific entries mentions the user
															// which can be used by other service to know that this is a user that has been 
															// authenticated
				...
				.setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 10))  /// used to track expiration date
				.signWith(SignatureAlgorithm.HS256, SECRET_KEY)  // explicitly mentioning algorithm, and generating the hash
